...
**Все готово!** FreePBX будет доступен через 3-5 минут по адресу `http://YOUR_SERVER_IP:8080`
...
- **Web интерфейс:** http://YOUR_SERVER_IP:8080
- **HTTPS:** https://YOUR_SERVER_IP:8443  
- **SIP сервер:** YOUR_SERVER_IP:5060
- **SSH управление:** YOUR_SERVER_IP:2222
...
1. **Откройте веб-интерфейс:** http://YOUR_SERVER_IP:8080
